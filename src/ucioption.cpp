...
static void on_book_file(const Option& o) { polybook[0].init(o); }
...
void init(OptionsMap& o) {
  ...
  o["PersonalityBook"]                     << Option(false);
  o["Book File"]                           << Option("<empty>", on_book_file);
  o["Book Width"] << Option(5, 1, 20);
  o["Book Depth"]                          << Option(5, 1, 30);
  o["Experience Enabled"]                  << Option(true, on_exp_enabled);
  o["Experience File"]                     << Option("Tal.exp", on_exp_file);
